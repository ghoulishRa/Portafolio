...
char uart_buf[50]; //buffer de transmision
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  //funciones para configurar timer para pwm
  HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1);
  HAL_GPIO_WritePin(GPIOE,GPIO_PIN_14,GPIO_PIN_SET);
  HAL_GPIO_WritePin(GPIOG,GPIO_PIN_14,GPIO_PIN_RESET);


  //funciones para inicializar MPU
  MPU6050_init();

  //funciin para incializar timer para recopilar datos
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, IN2_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IN2_Pin LD2_Pin */
  GPIO_InitStruct.Pin = IN2_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	if (htim == &htim3)
			{
			    ...
			    MPU6050_read_gyro();
			    		gx_[cont_2048] = omega_x;//omega_x;
			    		gy_[cont_2048] = omega_y;
			    		gz_[cont_2048] = omega_z;
			    	  	if(cont_2048%2 ==0)
			    		{
			    		  gx_1024[cont_1024]= omega_x;
			    		  gy_1024[cont_1024]= omega_y;
			    	      gz_1024[cont_1024]= omega_z;
			    	      cont_1024++;
			    		}
			    	  	if(cont_2048%4 == 0)
			    	  	{
			    	  		gx_512[cont_512]= omega_x;
			    	        gy_512[cont_512]= omega_y;
			    	  		gz_512[cont_512]= omega_z;
			    	  		cont_512++;
			    	  	}
			    	  	cont_2048 ++;
			    	  	if(cont_2048 == 2048)
	...
	if (htim == &htim13)
	{
		...
		formato_uart = sprintf(uart_buf,"%.6f \r\n",gx_[stop]);
